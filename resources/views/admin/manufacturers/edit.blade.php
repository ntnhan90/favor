    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ URL::to('admin/manufacturers')}}"><i class="fa fa-industry"></i> {{ trans('labels.Manufacturer') }}</a></li>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body manufacturer-image-embed">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                      <a href="{{url('admin/media')}}" target="_blank" class="btn btn-primary pull-left" >{{ trans('labels.Add Icon') }}</a>
