    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ URL::to('admin/products') }}"><i class="fa fa-database"></i>{{ trans('labels.ListingAllProductsImages') }}</a></li>
                      ...
                      <div class="box-header">
                        ...
                        <div class="box-body">
                            ...
                            <div class="box-footer text-center">
                                <a href="{{ URL::to("admin/products")}}" class="btn btn-default">{{ trans('labels.Save_And_complete') }}</a>
                            </div>
                        </div>
                        <!-- /.box-body -->
                    </div>
