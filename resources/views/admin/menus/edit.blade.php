                                              ...
                                              <div class="col-sm-10 col-md-4">
                                                <select class="form-control" name="page_id">
                                                  @foreach($result['pages'] as $page)
                                                      <option @if($result['menus'][0]->link == 'page/'.$page->slug) selected @endif value="{{$page->slug}}">{{ $page->name}}</option>
                                                  @endforeach
                                                </select>
                                              <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                              {{ trans('labels.GeneralStatusText') }}</span>
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                  <select class="form-control" name="category_slug">
                                                    @foreach($result['categories'] as $category)
                                                        <option value="{{$category->slug}}" @if($result['menus'][0]->link == 'cate/'.$category->slug) selected @endif >{{ $category->name}}</option>
                                                    @endforeach
                                                </select>
                                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                {{ trans('labels.GeneralStatusText') }}</span>
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                  <select class="form-control" name="product_slug">
                                                    @foreach($result['products'] as $product)
                                                        <option value="{{$product->products_slug}}" @if($result['menus'][0]->link == 'product/'.$product->products_slug) selected @endif>{{ $product->products_name}}</option>
                                                    @endforeach
                                                </select>
                                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                {{ trans('labels.GeneralStatusText') }}</span>
